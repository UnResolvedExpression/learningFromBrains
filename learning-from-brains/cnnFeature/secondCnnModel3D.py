...
class Dec(nn.Module):
    def __init__(self):
        ...
        # )
        self.decoder = nn.Sequential(
            # nn.ConvTranspose3d(1, 8, 2, stride=1, output_padding=0),#1
            # nn.ConvTranspose3d(8, 4, 2, stride=1, output_padding=0),#1
            # nn.ConvTranspose3d(4, 1, 2, stride=1, output_padding=0)
