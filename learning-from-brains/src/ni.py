...
def ni(sub,task,run,sample) -> Dict[str, torch.tensor]:
...
#    print(nl.image.load_img(path).shape)
    ...
    directoryPath="C:/Users/ghait/Repos/learningFromBrains/hcp/100307/analysis/100307_2_fsaverage_3T_rfMRI_REST1_LR-lh.stc"
    ...
    fileObj=open(fmriPath)
    #print(fileObj)
    #print("sep")
    fmriData=mne.read_source_estimate(fmriPath)
    ...
    plotting.show()
    connectome= Connectome.connectome_batch(None,None,None,fmriData)
