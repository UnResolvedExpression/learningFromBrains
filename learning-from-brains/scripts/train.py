...
def train(config: Dict=None) -> Trainer:
    ...
    print("train_dataset")
    print(train_dataset)
    print(train_dataset.sample_keys)
...
def get_args() -> argparse.ArgumentParser:
    ...
    #TODO update with correct dimension?
    # Embedder settings:    
    parser.add_argument(
        '--embedding-dim',
        metavar='INT',
    ...
    parser.add_argument(
        '--seq-max',
        metavar='INT',
        default=50, #TODO perhaps this changes the number of sequences
        type=int,
